...
/// @nodoc
@JsonSerializable()
class _$_MovieVideo extends _MovieVideo {
  const _$_MovieVideo(
      {required this.id,
  ...
  @override
  String toString() {
    return 'MovieVideo(id: $id, iso6: $iso6, iso3: $iso3, videoName: $videoName, videoKey: $videoKey, site: $site, videoSize: $videoSize, videoType: $videoType, isOfficial: $isOfficial, publishedAt: $publishedAt)';
  }
...
abstract class _MovieVideo extends MovieVideo {
