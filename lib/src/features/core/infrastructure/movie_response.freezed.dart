...
/// @nodoc
abstract class $MovieRemoteResponseCopyWith<T, $Res> {
  factory $MovieRemoteResponseCopyWith(MovieRemoteResponse<T> value,
          $Res Function(MovieRemoteResponse<T>) then) =
      _$MovieRemoteResponseCopyWithImpl<T, $Res, MovieRemoteResponse<T>>;
}

/// @nodoc
class _$MovieRemoteResponseCopyWithImpl<T, $Res,
        $Val extends MovieRemoteResponse<T>>
    implements $MovieRemoteResponseCopyWith<T, $Res> {
  _$MovieRemoteResponseCopyWithImpl(this._value, this._then);
...
class __$$_NoConnexionCopyWithImpl<T, $Res>
    extends _$MovieRemoteResponseCopyWithImpl<T, $Res, _$_NoConnexion<T>>
...
class _$_NoConnexion<T> extends _NoConnexion<T> {
  ...
  @override
  String toString() {
    return 'MovieRemoteResponse<$T>.noConnexion()';
  }
...
abstract class _NoConnexion<T> extends MovieRemoteResponse<T> {
...
class __$$_NotModifiedCopyWithImpl<T, $Res>
    extends _$MovieRemoteResponseCopyWithImpl<T, $Res, _$_NotModified<T>>
...
class _$_NotModified<T> extends _NotModified<T> {
  ...
  @override
  String toString() {
    return 'MovieRemoteResponse<$T>.notModified(maxPage: $maxPage)';
  }
...
abstract class _NotModified<T> extends MovieRemoteResponse<T> {
...
class __$$_WithNewDataCopyWithImpl<T, $Res>
    extends _$MovieRemoteResponseCopyWithImpl<T, $Res, _$_WithNewData<T>>
...
class _$_WithNewData<T> extends _WithNewData<T> {
  ...
  @override
  String toString() {
    return 'MovieRemoteResponse<$T>.withNewData(data: $data, maxPage: $maxPage)';
  }
...
abstract class _WithNewData<T> extends MovieRemoteResponse<T> {
