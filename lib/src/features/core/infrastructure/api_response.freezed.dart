...
class __$$_SucessCopyWithImpl<T, $Res>
    extends _$ApiResponseCopyWithImpl<T, $Res, _$_Sucess<T>>
...
class _$_Sucess<T> extends _Sucess<T> {
  const _$_Sucess(this.data) : super._();
...
abstract class _Sucess<T> extends ApiResponse<T> {
  const factory _Sucess(final T data) = _$_Sucess<T>;
...
class __$$_ErrorCopyWithImpl<T, $Res>
    extends _$ApiResponseCopyWithImpl<T, $Res, _$_Error<T>>
